...
- JavaScript and declaration source maps now embed their TypeScript sources instead of referencing files omitted from the npm package.
- Package smoke tests now reject missing or incomplete `sourcesContent` in generated source maps.
